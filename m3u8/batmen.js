(function() {
  ...
  function component(object) {
    ...
    this.rch = function(json, noreset) {
      ...
      if (typeof signalR == 'undefined') {
        Lampa.Utils.putScript(["http://batmen.my.to/signalr-6.0.25_es5.js"], function() {}, false, function() {
          load();
        }, true);
      } else load();
    };
  ...
  function startPlugin() {
    ...
    var manifst = {
      ...
      version: '',
      name: 'BATmen',
      description: 'Плагін для перегляду',
      component: 'bat',
